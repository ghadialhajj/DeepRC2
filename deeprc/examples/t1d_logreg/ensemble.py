...
with open('/storage/ghadia/DeepRC2/results/T1D_AC_clip/folds_outputs.pkl', 'rb') as f:
...
with open('/storage/ghadia/DeepRC2/results/T1D_AC_clip/folds_outputs23.pkl', 'rb') as f:
